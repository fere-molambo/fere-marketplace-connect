...
const statusConfig: Record<string, { label: string; className: string }> = {
  pending: { label: "Paiement en attente", className: "bg-yellow-100 text-yellow-800 border-yellow-200" },
  partial: { label: "Paiement partiel", className: "bg-orange-100 text-orange-800 border-orange-200" },
